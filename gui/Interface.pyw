...
Computer = t.Button(explorer,text="DESKTOP",bg="black",fg="#1CFDE4",font=("fangsongti", 15), width="10", height="1",borderwidth=0, command=desktop);
Computer.configure(font=("mincho", 12, "bold"))
